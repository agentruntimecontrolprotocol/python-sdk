"""ARCP wire envelope (spec §5): 8 fields, `arcp` constant, mutable pydantic model.
...
is fixed by spec §5 (Wire Format); `extra="allow"` preserves
forward-compatible vendor extensions verbatim.
"""
...
class Envelope(BaseModel):
    """Outer envelope for every wire frame. 8 fields per spec §5.
